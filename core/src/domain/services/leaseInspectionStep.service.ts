...
export class LeaseInspectionStepService {
    ...
    async create(leaseInspectionStepDto: LeaseInspectionStepWithFileDto): Promise<LeaseInspectionStepWithLinkDto> {
        ...
        if (!leaseInspectionStepDto.pictures) {
            return LeaseInspectionStepDtoMapper.fromModelWithLink(leaseInspectionStep, undefined);
        }
    ...
    async update(leaseInspectionStepId: string, leaseInspectionStepDto: LeaseInspectionStepWithFileDto): Promise<LeaseInspectionStepWithLinkDto> {
        ...
        if (!leaseInspectionStepDto.pictures) {
            return LeaseInspectionStepDtoMapper.fromModelWithLink(await this.repository.updateElement(leaseInspectionStepUpdated), undefined);
        }
    ...
    updateState(leaseInspectionStep: LeaseInspectionStep) {
        switch (leaseInspectionStep.state) {
            case LeaseInspectionStepState.PENDING:
                if (leaseInspectionStep.rating != null && leaseInspectionStep.rating >= 0) {
