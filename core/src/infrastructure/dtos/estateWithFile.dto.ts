...
export class EstateWithFileDto {
    @IsOptional()
    ...
    constructor (id: string, name: string, streetNumber: string, streetName: string, zipCode: number, city: string, floor: number, flatNumber: number, description: string, livingSpace: number, roomCount: number, type: EstateTypeDto, classType: ClassTypeDto, heaterType: HeaterTypeDto, waterHeaterType: WaterHeaterTypeDto, ownerId: string) {
